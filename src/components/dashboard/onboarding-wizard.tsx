        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <button
              ...
              className={`nm-raised flex flex-col items-center gap-2 rounded-xl p-3 text-center transition-all ${
            ...
            >
              ...
              <span className="text-muted-foreground/60 rounded-full bg-white/5 px-1.5 py-0.5 text-[10px]">
                Soon
              </span>
            </button>
