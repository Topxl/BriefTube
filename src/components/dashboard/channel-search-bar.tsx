    ...
    <div className="relative">
      <div className="relative w-full" suppressHydrationWarning>
        <Input
          ...
          className="scrollbar-fade-x placeholder:text-muted-foreground/60 h-9 rounded-full border-white/[0.07] bg-[oklch(0.18_0_0)]/50 pr-8 pl-3 text-sm shadow-[0_4px_16px_rgba(0,0,0,0.3)] backdrop-blur-xl focus-visible:border-white/[0.12] focus-visible:ring-0"
          autoComplete="off"
          data-1p-ignore
          data-lpignore="true"
