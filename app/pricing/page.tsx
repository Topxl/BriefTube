...
export default async function PricingPage() {
  ...
  const [userRes, initialPrices] = await Promise.all([
        ...
        <div className="mt-16 flex flex-col gap-10 border-t border-white/[0.06] pt-12">
          ...
          <section className="flex flex-col gap-3">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              YouTube channels as you want. On top of Plus features, Pro gives
              you the ability to choose a specific voice from several neural TTS
          ...
          <section className="flex flex-col gap-3">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              processed in standard order. On Pro, your request jumps ahead in
              the queue. In practice this means Pro summaries typically arrive
              within a few minutes of a video going live, while free-plan
              summaries may take up to 30 minutes during busy periods.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-3">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              billing period. Your channels stay, your summary history stays,
              you just lose access to the Pro features. No cancellation fees, no
