...
export default async function ComparisonPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      />
      <div className="bg-background/80 sticky top-0 z-50 border-b border-white/[0.08] backdrop-blur-sm">
        ...
        <div className="flex flex-col gap-12">
          ...
          <section className="flex flex-col gap-4 rounded-xl border border-white/[0.08] bg-red-600/10 p-6">
            ...
            <Typography variant="p">
              Get started free with 3 channels, or try Pro for 7 days to unlock
              unlimited channels and never miss an update.
            </Typography>
            <div>
              <Link href="/login">
